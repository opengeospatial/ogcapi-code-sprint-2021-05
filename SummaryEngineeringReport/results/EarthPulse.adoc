...
We have failed to display the vector tiles from the deployed server on this client, as it only consumes raster tiles. An issue was opened https://github.com/frontiersi/leaflet-ogc-layers/issues/1[here], which clarifies the topic.
